...
def findBlobs(ImageName):
    ...
    boardPreFire=copy.copy(board) #saves the current unburnt state of the board for testing purposes
    ...
    return([biomeBlobList,boardPreFire])
